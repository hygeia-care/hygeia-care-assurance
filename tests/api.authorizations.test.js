...
describe("Authorizations API", () => {
    ...
    describe("GET /authorizations", () => {
        ...
        it("Should return all authorizations", () => {
            ...
            return request(app).get("/api/v1/authorizations").then((response) => {
    ...
    describe("GET /authorizations/:id", () => {
        ...
        it("Should return authorization given its id", () => {
            ...
            return request(app).get("/api/v1/authorizations/1").then((response) => {
                expect(response.statusCode).toBe(200);
    ...
    describe("POST /authorizations", () => {
        ...
        it("Should add a new authorization if everything is fine", () => {
            ...
            return request(app).post("/api/v1/authorizations").send(authorization).then((response) => {
    ...
    describe("DELETE /authorizations/:id", () => {
        ...
        it("Should delete authorization given its id", () => {
            ...
            return request(app).delete("/api/v1/authorizations/"+authorization._id).then((response) => {
                expect(response.statusCode).toBe(200);
        ...
        it("Should return 404 if the authorization does not exist", () => {
            ...
            return request(app).delete("/api/v1/authorizations/"+(authorization._id+1)).then((response) => {
                expect(response.statusCode).toBe(404);
    ...
    describe("PUT /authorizations/:id", () => {
        ...
        it("Should update authorization given its id", () => {
            ...
            return request(app).put("/api/v1/authorizations/"+authorization._id).send(updatedBody).then((response) => {
                expect(response.statusCode).toBe(200);
                expect(response.body.name).toEqual("TestAuthorization");
        ...
        it("Should return 404 if the authorization does not exist", () => {
            ...
            return request(app).put("/api/v1/authorizations/"+(authorization._id+1)).send(updatedBody).then((response) => {
                expect(response.statusCode).toBe(404);
                expect(dbfindByIdAndUpdate).toBeCalled();
            });
        });
